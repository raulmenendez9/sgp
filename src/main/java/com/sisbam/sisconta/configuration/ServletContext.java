...
@ComponentScan(basePackages = "com.sisbam.sisconta.configuration")
@ComponentScan(basePackages = "com.sisbam.sisconta.controller")
@ComponentScan(basePackages = "com.sisbam.sisconta.dao")
@ComponentScan(basePackages = "com.sisbam.sisconta.entity")
