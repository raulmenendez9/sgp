...
<link
	...
	rel="stylesheet" type="text/css" />
<link href="<c:url value="${context}/resources/dist/css/sb-admin-2.css" />"
	rel="stylesheet" type="text/css" />
<link
	href="<c:url value="${context}/resources/vendor/font-awesome/css/font-awesome.min.css" />"
	rel="stylesheet" type="text/css" />
<link rel="icon" href="<c:url value="${context}/resources/img/it.ico" />" />
